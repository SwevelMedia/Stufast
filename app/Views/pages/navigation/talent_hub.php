...
<link rel="stylesheet" href="style/talent-hub.css">
...
<style>
    ...
    #talent .btn-filter-wrapper {

        position: relative;

    }

    #talent .btn-filter-wrapper .filter-container {
    ...
    #talent .btn-filter-wrapper .filter-container .filter-container__header {
    ...
    #talent .btn-filter-wrapper .filter-container .filter-container__header h3 {
    ...
    #talent .btn-filter-wrapper .filter-container .filter-container__header a {
    ...
    #talent .btn-sorting-wrapper .sorting-container {
    ...
    #talent .btn-sorting-wrapper .sorting-container .sorting-container__header {
    ...
    #talent .btn-sorting-wrapper .sorting-container .sorting-container__header h3 {
    ...
    #talent .btn-sorting-wrapper .sorting-container .sorting-container__header a {
    ...
    .accordion-button::after {
        ...
        border-radius: 50%;
        /* Membuat sudut melengkung untuk membentuk latar belakang bulat */
    }
    ...
    <div class="content-container">
        <div class="container-fluid">
            <div class="row d-flex justify-content-center">
                <div class="content col-md-5 col-12 d-flex flex-column justify-content-center align-items-center text-start text-md-start">
                    <div class="ms-2">
                        <h1>Bergabung dan</h1>
                        <h1>Menjadi Talent di Stufast</h1>
                        <div class="d-md-block d-none float-md-end my-3 my-md-0">
                            <svg xmlns="http://www.w3.org/2000/svg" width="192" height="22" viewBox="0 0 192 22" fill="none">
                                <g clip-path="url(#clip0_1597_21426)">
                        ...
                        <a href="#talent" class="btn btn-success mt-4 mb-4 me-3 btn-talent">
                        ...
                        <a href="#talent" class="btn btn-outline-success mt-4 mb-4">Cari Talent</a>
                    </div>
                </div>
                <div class="image d-none d-md-block col-12 col-md-6">

                    <img style="max-width: 70%; float: right; " src="image/talent-hub/gambar3.png" alt="img" class="img-fluid">
...
<div class="mt-4" id="program-talent">
...
<div id="talent">
    <div class="container-fluid">
        <div class="training-wrapper justify-content-between align-items-center m-4">
            <div class="text-center titles">
                <h2 class="title">Temukan <span style="color: #21743d;">Talent</span></h2>
                <div class="row">
                    <div class="col-md-4 offset-md-5">
                        <svg xmlns="http://www.w3.org/2000/svg" width="145" height="14" viewBox="0 0 185 14" fill="none" class="line">
                            ...
                            <path d="M13.0399 14C13.2474 14 13.4157 13.84 13.4157 13.6426C13.4157 13.4452 13.2474 13.2852 13.0399 13.2852C12.8323 13.2852 12.6641 13.4452 12.6641 13.6426C12.6641 13.84 12.8323 14 13.0399 14Z" fill="#248043" />
                        </svg>
                    </div>
                </div>
                <p>Cari talent sesuai dengan kebutuhan perusahaan Anda!</p>
            </div>

            <div class="mb-4 mt-4">
                <h4>Rekomendasi Talent</h4>
                <p>Berdasarkan profil Anda, preferensi perusahaan, dan aktifitas terkini</p>
                        ...
                        <div class="text-start">
                            <form>
                                <div class="input-group mb-2">
                                    <input type="text" class="form-control mb-2" id="search" placeholder="Cari talent ..." autocomplete="off" style="height: 45px;">
                                            ...
                                            <div class="accordion">
                                                ...
                                                <div class="accordion-item">
                                                    ...
                                                    <h2 class="accordion-header">
                                                        ...
                                                        <button class="accordion-button d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#accordion-hire" style="background-color: #248043; color: white; ">
                                                    ...
                                                    <div id="accordion-status" class="accordion-collapse p-2 collapse show">

                                                        <div class="filter-item text-start">

                                                            <div class="d-flex gap-1">

                                                                <input type="checkbox" name="status" value="Pegawai Tetap">

                                                                <label class="mt-2">Pegawai Tetep</label>

                                                            </div>

                                                            <div class="d-flex gap-1">

                                                                <input type="checkbox" name="status" value="Freelance">

                                                                <label class="mt-2">Freelance</label>
                                                ...
                                                <div class="accordion-item">
                                                    ...
                                                    <h2 class="accordion-header">
                                                        ...
                                                        <button class="accordion-button d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#accordion-metode" style="background-color: #248043; color: white; ">
                                                    ...
                                                    <div id="accordion-method" class="accordion-collapse p-2 collapse show">

                                                        <div class="filter-item text-start">

                                                            <div class="d-flex gap-1">

                                                                <input type="checkbox" name="method" value="WFO">

                                                                <label class="mt-2">WFO</label>

                                                            </div>

                                                            <div class="d-flex gap-1">

                                                                <input type="checkbox" name="method" value="Remote">

                                                                <label class="mt-2">Remote</label>
                                                ...
                                                <div class="accordion-item">
                                                    ...
                                                    <h2 class="accordion-header">
                                                        ...
                                                        <button class="accordion-button d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#accordion-gaji" style="background-color: #248043; color: white; ">
                                                    ...
                                                    <div id="accordion-gaji" class="accordion-collapse p-2 collapse show">
                                                        ...
                                                        <div class="filter-item text-start">
                                                            ...
                                                            <div class=" ">
                                                                ...
                                                                <div class="input-group mb-1 mt-2">
                                                                    ...
                                                                    <input id="min_salary" type="number" class="form-control" placeholder="Nilai Minimal" aria-label="Nilai minimal" aria-describedby="basic-addon1">
                                                                ...
                                                                <div class=" ">
                                                                    ...
                                                                    <div>
                                                                        <h6 class="text-center mb-1 mt-1" style="font-family: Plus Jakarta Sans;  font-weight: normal; color: grey; font-size: 16px;"><i class="bi bi-dash-lg"></i></h6>
                                                                    </div>
                                                                ...
                                                                <div class="input-group mb-2 mt-1">
                                                                    ...
                                                                    <input id="max_salary" type="number" class="form-control" placeholder="Nilai maksimal" aria-label="Nilai Minimal" aria-describedby="basic-addon1">
                            ...
                            <span class="sorting btn-sorting-wrapper">
                                ...
                                <div class="sorting-container d-none">
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="row border"><button class="btn-sort btn btn-outline-success" data-value="average_score" data-order="desc">Berdasarkan Nilai Tertinggi</button></div>

                                        <div class="row border"><button class="btn-sort btn btn-outline-success" data-value="total_course" data-order="desc">Berdasarkan Jumlah Course</button></div>

                                        <div class="row border"><button class="btn-sort btn btn-outline-success" data-value="fullname" data-order="asc">Berdasarkan Nama (A-Z)</button></div>

                                        <div class="row border"><button class="btn-sort btn btn-outline-success" data-value="fullname" data-order="desc">Berdasarkan Nama (Z-A)</button></div>
            ...
            <div id="talent-list" class="row m-5"></div>

            <!-- PAGINATION -->

            <div class="talent-pagination mt-5 text-center" style="padding-bottom: 40px;">
...
<script src="../../../js/home/talent-hub.js"></script>
<script>
