...
<div class="container">
    ...
    <!-- <section style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        ...
        <ol class="breadcrumb navigation">
            ...
            <li class="breadcrumb-item course_title_content breadcrumb-anchor" aria-current="page" href="">Peluang Karir Seorang UI/UX Designer</li>
    ...
    <div class="container row d-none mt-4" id="content">

        <section class="col-md-8 col-12">

            <h3 class="title">Peluang Karir Seorang UI/UX Designer</h3>

            <p class="category mb-3">UI/UX</p>

            <img class="banner mb-3 img-fluid" src="/image/webinar-training/webinar-banner.png" alt="webinar-banner">
        ...
        <section class="mt-3 col-md-4 col-12">
            ...
            <section class="detail">
                ...
                <div class="order-card">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <p class="order-list mb-2 title">

                            Training Intro to Coding

                        </p>

                        <p class="order-price mb-2 price">
                    ...
                    <button class="mt-2 checkout">Beli</button>
...
<script src="/js/api/training/training-detail.js"></script>
