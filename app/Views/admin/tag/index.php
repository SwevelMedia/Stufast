...
<div class="mb-4 d-flex justify-content-between">
    ...
    <button class="btn btn-success btn-sm" type="button" data-bs-toggle="modal" data-bs-target="#modalTag">Tambah</button>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="modalTagLabel">Buat Tag</h1>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <h5>Hapus tag?</h5>
                <p class="text-muted">
                    Tag yang digunakan akan hilang,setelah kamu menghapusnya
                </p>
                <div class="row mt-3">
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        <button type="button" class="btn btn-danger btn-submit w-100">Ya, Hapus tag</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(data, function(index, value) {
                        ...
                        <td><button type="button" class="btn btn-warning btn-sm btn-edit" data-id="${value.tag_id}" data-name="${value.name}">Ubah</button> <button type="button" class="btn btn-danger btn-sm btn-delete" data-id="${value.tag_id}">Hapus</button></td>
                        </tr>`;
                    });
        ...
        $('#modalTag').on('click', '.btn-tambah', function(e) {
            e.preventDefault();
        ...
        $('#tbl-tag').on('click', '.btn-delete', function() {
            let id = $(this).data('id');
