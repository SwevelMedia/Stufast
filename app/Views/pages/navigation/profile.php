...
<?= $this->include('components/profile/cv_modal') ?>
...
<div class="container mt-4 text-center">
    ...
    <div class="row">
        ...
        <div class="col profile">
            ...
            <h4 class="text-start">Profil Saya</h4>

            <div class="row py-5" id="loading-profile">
            ...
            <div class="row">
                ...
                <div class="col-12 mb-4" style="padding: 0 10px 0 0;">
            ...
            <!-- <div hidden class="card">
                ...
                <div class="row d-flex justify-content-between align-items-center text-start">
                    ...
                    <div class="col-20">
                        ...
                        <p class="fw-light" id="created_at">For 3 months</p>
            ...
            <!-- <div hidden class="card">
                ...
                <span class="fw-bold text-start h5">Ongoing courses</span>
...
<script src="../../../js/api/profile/index.js?v=1.6"></script>

<script src="../../../js/api/profile/edit_profile.js?v=1.6"></script>
