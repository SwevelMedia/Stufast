$("#contact-us").on("click", function (event) {
    ...
    Swal.fire({
        ...
        html: `<div class="contact-popup d-flex flex-column bd-highlight mb-2">
    ...
    <form class="contact-form d-flex flex-column bd-highlight mb-2" enctype="multipart/form-data">

        <input class="px-2" type="email" placeholder="Email" name="email">

        <textarea class="p-1" name="question" id="" cols="0" rows="7" placeholder="Pesan" required></textarea>
        ...
        <div class="d-flex align-items-center file-group">
            ...
            <label for= "image-upload" class="custom-file-upload" >
                ...
                <input type="file" name="question_image" class="hide" id="image-upload" accept=".jpg, .jpeg, .png">
