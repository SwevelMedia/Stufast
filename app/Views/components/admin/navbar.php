<nav class="navbar <?php if (str_contains(uri_string(), 'admin')){echo 'navbar-admin';} ?> navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
